    ...
    <div className="home">
      <div className={isSafari ? "no-animation images" : "images"}>
        ...
        <div className="content">
          ...
          <Link to="/sunglasses" className="button">
            <GiClick className="clickIcon" />
            {t("home.shoppingWithLoveBTN")}
            <GiClick className="clickIcon" />
          </Link>
        </div>
      </div>
          ...
          <Grid item xs={12} md={10}>
            ...
            >
              ...
              <Box textAlign="center">
                <Typography variant="h4" fontWeight="bold" color="#e89bb8">
                  {t("home.chooseQuestion")}
                </Typography>
                <QuestionMarkIcon
                  sx={{ fontSize: 45, mt: 1, color: "#e89bb8" }}
                />
              </Box>
            ...
            >
              {[1, 2, 3, 4].map((num) => (
                <Grid item xs={12} sm={6} md={5} key={num}>
                  ...
                  >
                    <CheckCircleIcon
                      sx={{ fontSize: 30, mt: "3px", color: "#e89bb8" }}
                    />
                    <Typography
                      variant="body1"
