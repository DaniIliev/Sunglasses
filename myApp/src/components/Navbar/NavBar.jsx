...
const NavBar = () => {
  ...
  const { sunglasses, filterValues, setFilterValues, setFilteredSunglasses } =
    useContext(SunglassesContext);
    ...
    <div className="navBars">
      ...
      <div className="navBarOne">
        <div className="navigation">
          <input
            ...
            id="navi-toggle"
            onClick={() => setIsRepsonsivMenuOpen(!isResponsivMenuOpen)}
          />
              ...
              <List sx={{ px: 2 }}>
                <ListItem disablePadding>
                  <ListItemButton
                    ...
                    component={Link}
                    to="/sunglasses"
                    onClick={() => setIsRepsonsivMenuOpen(false)}
                  >
        ...
        <Link to="/">
          <img src="/VistOpticsWithText.png" alt="" className="logo" />
        </Link>
        <SearchBar />
        ...
        <div className="aboutUser">
          ...
          {user ? (
            <p className="welcomeUsernam">{`Welcome, ${user.username}`}</p>
          ) : (
            ""
          )}
          {user ? (
            <Typography
              className="hidden"
              sx={{ cursor: "pointer", color: "#EEAECA" }}
            ...
            <Link to={"/user/access"}>
              <PersonIcon className="personIcon personIconNone" />{" "}
            </Link>
          )}
      ...
      <div className="navBarTwo">
        <nav>
          ...
          {user?._id == "68092d56a17f6bacd78b1bc4" && (
            <Link to="/create">Добавинов модел</Link>
          )}
          {user?._id == "68092d56a17f6bacd78b1bc4" && (
            <Link to="/ordersList">Виж поръчките</Link>
          )}
        </nav>
      </div>
      {isShippingHovered ? (
        <CartDropdown
          setIsShippingHovered={setIsShippingHovered}
          isShippingHovered={isShippingHovered}
        />
      ) : (
        ""
      )}
      {isUserIconHovered ? (
        <UserDropdown
          setIsUserIconHovered={setIsUserIconHovered}
          isUserIconHovered={isUserIconHovered}
        />
      ) : (
        ""
      )}
        ...
        <div className="menuMen">
          ...
          <div className="lensOptions">
            ...
            <ul>
              ...
              <li>
                <img src="../../../images/dioptric.png" alt="" />
                Diobtric sunglasses
              </li>
            </ul>
          </div>
          <div className="frameShape">
            ...
            <ul>
              <li>Show all</li>
              <li>
                <img src="../../../images/round.jpeg" alt="" />
                Round
              </li>
              <li>
                <img src="../../../images/squared.jpeg" alt="" />
                Squared
              </li>
              <li>
                <img src="../../../images/rechtangular.jpeg" alt="" />
                Rechtangular
              </li>
              <li>
                <img src="../../../images/pilotAviator.jpeg" alt="" />
                Pilot / Aviator
              </li>
              <li>
                <img src="../../../images/catEye.jpeg" alt="" />
                Cat eye
              </li>
            </ul>
          </div>
